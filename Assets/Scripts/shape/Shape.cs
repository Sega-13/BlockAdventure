...
namespace GameBlockAdv.SquareShape
{
    ...
    IEndDragHandler, IDragHandler
    {
        ...
        [SerializeField] private Vector2 offset = new Vector2(0f, 700f);
        ...
        public bool IsOfAnyShapeSquareActive()
        {
        ...
        {
            if (IsOnStartPosition() == false && IsOfAnyShapeSquareActive())
            {
                foreach (var square in _currentShape)
                {
        ...
        private float GetXPositionForShapeSquare(ShapeData shapeData, int column, Vector2 moveDistance)
        {
            ...
            if (shapeData.columns > 1)
            {
                ...
                {
                    var middleSuareIndex2 = (shapeData.columns == 2) ? 1 : (shapeData.columns / 2);
                    var middleSquareIndex1 = (shapeData.columns == 2) ? 0 : shapeData.columns - 1;
                    var multiplier = shapeData.columns / 2;
                    if (column == middleSquareIndex1 || column == middleSuareIndex2)
                    {
                        if (column == middleSuareIndex2)
                    ...
                    else if (column > middleSquareIndex1 && column > middleSuareIndex2)
                    {
                        shiftOnX = moveDistance.x * 1;
                        shiftOnX *= multiplier;
                    }
