...
namespace GameBlockAdv.Grid
{
    public class GridBlock : MonoBehaviour
    {
        ...
        [SerializeField] private float everySquareOffeset = 0.0f;
        ...
        private List<SquareColor> colorsInGrid = new List<SquareColor>();
        ...
        private List<SquareColor> GetAllColorsInGrid()
        {
        ...
        void CheckIfAnyLineIsCompleted()
        {
            ...
            for (int row = 0; row < 9; row++)
            {
                ...
                {
                    data.Add(_lineIndicator.GetLineData(row, index));
                }
            ...
            for (var square = 0; square < 9; square++)
            {
                ...
                {
                    data.Add(_lineIndicator.GetSquareData(square, index));
                }
                lines.Add(data.ToArray());
            }
        ...
        private int ShouldPlayColorBonusAnim()
        {
            ...
            SquareColor colorToPlayBonus = SquareColor.Notset;
            ...
            if (colorToPlayBonus == SquareColor.Notset)
            {
                return 0;
            }
        ...
        private List<int[]> GetAllSquaresCombination(int columns, int rows)
        {
            ...
            while (lastRowIndex + (rows - 1) < 9)
            {
                ...
                for (var row = lastRowIndex; row < lastRowIndex + rows; row++)
                {
                    ...
                    {
                        rowData.Add(_lineIndicator.GetLineData(row, column));
                    }
                }
